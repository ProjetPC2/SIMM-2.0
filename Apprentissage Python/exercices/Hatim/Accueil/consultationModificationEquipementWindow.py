...
class ConsultationModificationEquipement(QWidget):
    ...
    def initUI(self):
        ...
        #Création d'un champs d'entrée de texte pour l'ID
        identifiantEdit = QLineEdit()


        # creation de la ligne pour la categorie d'equipement
        categorieEquipementLabel = QLabel("Voiture", self)
        marqueLabel = QLabel("BMW", self)
        modeleLabel = QLabel("740i ", self)
        numSerieLabel = QLabel("A8730B8X474 ", self)
        salleLabel = QLabel("Asphalte", self)
        centreServiceLabel = QLabel("Deutchland service center", self)
        dateAcquisitionLabel = QLabel("05-04-1997 ", self)
        dateEntretienLabel = QLabel("21-05-2015", self)
        provenanceLabel = QLabel("Allemagne", self)
        etatServiceLabel = QLabel("Beast Machine", self)
        etatConservationLabel = QLabel("Carrosserie rouillée", self)
        commentairesLabel = QLabel("Voici certains commentaires qui pourraient être faits\nlors d'un entretien.", self)
        ...
        self.refreshButton = QPushButton("Afficher l'Équipement")
        self.refreshButton.setIcon(QtGui.QIcon("refresh.png"))
        self.refreshButton.setIconSize(QtCore.QSize(20, 20))

        self.accueilButton = QPushButton("Accueil")
        self.accueilButton.setIcon(QtGui.QIcon("home.png"))
        self.accueilButton.setIconSize(QtCore.QSize(20, 20))
    ...
    def NouveauBonDeTravail(self, event):
        ...
        message = QMessageBox()
        message.setWindowIcon(QIcon('pc2-icon.png'))
